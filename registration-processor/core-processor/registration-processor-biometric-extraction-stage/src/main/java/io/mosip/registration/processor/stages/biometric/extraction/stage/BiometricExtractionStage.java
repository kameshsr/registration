...
public class BiometricExtractionStage extends MosipVerticleAPIManager{
	...
	private IdResponseDTO addBiometricExtractiontoIdRepository((List<ExtractorDto> dtoList,
		...
		IdResponseDTO response= (IdResponseDTO) registrationProcessorRestClientService.putApi(ApiName.IDREPOEXTRACTBIOMETRICS, segments, queryParmeter.toString(), queryValue.toString(), null, IdResponseDTO.class, null);		if (response.getErrors() != null && !response.getErrors().isEmpty()) {
